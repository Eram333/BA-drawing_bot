...
# Calculates the angles q1 and q2 of one arm given the end-effector coordinates (x, y)
...
# plots the position of one arm based on angles q1 and q2
...
# calculates angles of both arms
def ik_delta(p):
    x = p[0]
    y = p[1]
    q1,_ = ik_serial(x-d,y,True) # arm right
    q0,_ = ik_serial(x+d,y,False) # arm left
